...
func _on_trigger_conclusion():
	if bad_soul_ammount > good_soul_ammount: # if bad > good -> get dicitonary for bad souls
		dialog_box.dialog_dictionary = "endgame_1"
	elif good_soul_ammount > bad_soul_ammount: # if good > bad -> get dictionary for good souls
		dialog_box.dialog_dictionary = "endgame_2"
	elif good_soul_ammount == bad_soul_ammount:	# if same ammount of both -> dictionary for both
		dialog_box.dialog_dictionary = "endgame_3"
